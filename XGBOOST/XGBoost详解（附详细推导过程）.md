...
## 1 监督学习关键概念回顾 
### 1.1 监督学习中原理
![](index_files/48ed54a8-6069-44c5-b88c-88263d5f9196.png)
...
### 1.2 监督学习中的目标函数
![](index_files/46a5ee88-0a85-4833-9ae4-c28e81d754b6.png)
**说明：**
...
### 1.3 模型的目标函数和正则项举例
![](index_files/0b786e2e-573e-45ff-871e-9e19bbbb265d.png)
说明：对常见的模型进行举例说明。
...
![](https://github.com/KARL13YAN/learning/raw/master/pic/1%20dt%20divide.png)

三种比较常见的**分类决策树**分支划分方式包括：ID3, C4.5, CART
![](https://github.com/KARL13YAN/learning/raw/master/pic/1%20dt%20type.png)
...
### 2.2 算法描述
![](index_files/d6a5f433-e09c-41ec-8523-8a411f7ac4f4.jpg)

### 2.3 单变量回归树
![](index_files/11a2f438-023a-48eb-876b-c21d424e2b45.png)
...
![](index_files/17dfe2c2-1b93-4edc-ab8f-be531664ef64.png)
...
![](index_files/1921fc00-ac4b-41e2-aa56-93477f471ad9.jpg)


公式如下图，$\hat{y}_i$ = $\sum$$_{k=1}^K$$f_k$$x_{ij}$, $f_k\in F$ 。每个样本点的残差是所有回归树残差之和。

![](index_files/80a0db83-3384-4d63-bd60-cb7e00e6b66b.png)
...
![](index_files/0c965056-9b6e-47aa-9348-54c2305c9852.png)

### 3.1 最小二乘损失函数推导
![](index_files/893083cc-12c1-4520-a555-547f56ec47c0.png)
说明：
...
### 3.2 泰勒展开损失函数
![](index_files/a1312a8c-f8cc-4b6f-8ff0-7a7018aa76e2.png)
说明：
...
#### 3.3.1 回归树求解
![](index_files/eca1f49b-62c3-46f8-a325-1221186a48e2.jpg)
说明：
...
#### 3.3.2 正则项求解
![](index_files/b598306c-712b-4616-8d1a-b8547097f291.jpg)
如上图所示，正则项如下：
...
#### 3.3.3 合并简化
![](index_files/b9b3cf40-4a2e-45f2-b790-01d00667ded0.png)
...
#### 3.3.4 目标函数再次简化
![](index_files/fe21b0c0-cd83-4935-aa18-ac4a95ae729a.png)
说明：
...
#### 3.3.5 打分计算案例
##### 样本说明
![](index_files/771f9e9e-58f9-4c52-9a4e-e786adca59f2.jpg)
...
![](index_files/ec182fb4-6b12-426f-a8f1-ed68baf9dcf1.jpg)
对于每次扩展，我们还是要枚举所有可能的分割方案，如何高效地枚举所有的分割呢？我假设我们要枚举所有x < a 这样的条件，对于某个特定的分割a我们要计算a左边和右边的导数和。
![](index_files/579d5ba1-dfa9-48fa-aa3c-a7865a8ddb91.jpg)
...
下面是论文中的算法：
![](index_files/c1484c14-42ef-4da7-80f7-7cfea029d4af.png)

#### 3.4.2 近似算法
主要针对数据太大，不能直接进行计算
![](index_files/e46ee7f1-aab3-42ff-9a9a-f762e3b004ef.png)

### 3.5 剪枝与正则化
![](index_files/2897d4cd-31c5-43ab-909f-15e475cb0cfc.png)
...
#### 3.6.3 回到时间序列的问题，如果想学习阶跃函数。除了从上到下的分割方法，还有其他学习时间分割的方法吗?
![](index_files/a2074b56-ffd8-4e71-b32c-e58d8d0a2989.png)
...
![](index_files/8428cae9-db5d-401a-b0ff-1268a682a53b.jpg)
